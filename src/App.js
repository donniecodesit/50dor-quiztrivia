...
function App() {
  const { modal, waiting, loading, questions, index, correct, nextQuestion, checkAnswers } = useGlobalContext();
  ...
  return (
    <main>
      ...
      <section className="quiz">
        <p className="correct-answers">Correct Answers: {correct}/{modal ? questions.length : index}</p>
